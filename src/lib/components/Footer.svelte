<script lang="ts">
	...
	function lineBreak(index: number) {
		if (index === 5) {
			return '';
		} else {
			return ' | ';
...
<div
	...
	from-cyan-200 to-purple-500 border-t dark:border-gray-500 "
>
	<div class="flex flex-row space-x-28 items-center justify-center">
		<div class="">
			<img src="/Group 13.png" alt="logo" class="w-96" />
		</div>
	...
	<div class="flex items-center justify-center w-full flex-col ">
		...
		<div class="text-white text-lg">WEBSITE DESIGN MADE WITH LOVE BY CHEMKIMISTRY 💖</div>
	</div>
</div>
...
<!-- <Footer footerType="socialmedia">
	<div class=" md:flex md:justify-between">
		<div class="flex items-center justify-center md:justify-start md:items-start mb-6 md:mb-0 py-8 md:py-0">
			<FooterBrand
				href="/"
				src="/heart.png"
				alt="The Priestess Heart banner"
				name="The Priestess Heart"
			/>
		</div>
		<div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
			<div>
				...
				<FooterLinkGroup>
					<FooterLink liClass="mb-4" href="/blogs">Blogs</FooterLink>
				</FooterLinkGroup>
			</div>
			<div>
				...
				<FooterLinkGroup>
					<FooterLink liClass="mb-4" href="https://www.facebook.com/thepriestessheart"
						>Facebook</FooterLink
					>
					<FooterLink liClass="mb-4" href="https://www.instagram.com/thepriestessheart"
						>Instagram</FooterLink
					>
				</FooterLinkGroup>
			</div>
			<div>
				<h2 class="mb-6 text-sm font-semibold uppercase text-gray-900 dark:text-white">Details</h2>
				<FooterLinkGroup>
					<FooterLink liClass="mb-4" href="/about">About Us</FooterLink>
					<FooterLink liClass="mb-4" href="/support">Support Us</FooterLink>
				</FooterLinkGroup>
			</div>
		</div>
	</div>
	...
	<div class="sm:flex sm:items-center sm:justify-between">
		<FooterCopyright
			href="/"
			by="The Priestess Heart™ - WEBSITE DESIGN MADE WITH LOVE BY CHEMKIMISTRY 💖"
		/>
